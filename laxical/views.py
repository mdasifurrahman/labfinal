...
def home(request):
    ...
    if request.method == "GET":
        return render(request, 'laxical/homepage.html')
...
##########################
        ...
        data_type = {'int': 'integer type', 'float': 'Floating point', 'char': 'Character type', 'long': 'long int', 'print':'Other 5'}
        ...
        return render(request, 'laxical/table.html', context)
